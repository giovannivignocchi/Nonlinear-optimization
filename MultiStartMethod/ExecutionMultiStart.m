...
% Notiamo che i parametri della funzione di ricerca locale vengono definiti
% nello script e verrano poi utilizati da multiStart direttamente.
localeps = 0.001;
eps = 0.001;
...
% Per ogni iterazione plotto punto ottenuto da algoritmo di ricerca locale.
figure;
plot(flocals,'*');
...
% 
figure;
axis([1,max_iter,0,fstars(1)+0.1]) % Riscalo ascisse e ordinate.
